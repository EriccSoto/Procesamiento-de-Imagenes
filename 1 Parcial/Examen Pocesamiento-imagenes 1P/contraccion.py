...
ruta_original = "lena.png" 
imgLenaa = abrir(ruta_original) #Imagen a Color
imgLenaBN = cv2.cvtColor(imgLenaa, cv2.COLOR_BGR2GRAY)#imagen a BN


umbral = 127 

# Binarización BN
imgLisa_bin_bn = Binarizado(imgLenaBN, umbral)

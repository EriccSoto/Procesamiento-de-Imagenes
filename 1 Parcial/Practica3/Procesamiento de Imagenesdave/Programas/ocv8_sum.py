...
im1 = cv2.cvtColor( cv2.imread('Paisaje.jpg'), cv2.COLOR_BGR2RGB )
#im2 = cv2.cvtColor( cv2.imread('Manzana.jpg'), cv2.COLOR_BGR2RGB )
im2 = cv2.cvtColor( cv2.imread('fig1.jpg'), cv2.COLOR_BGR2RGB )
...
sumaP = cv2.addWeighted( im1, 0.7, im2, 0.3, 0 )        #(im1*0.8) + (im2*0.2) + alpha = imgR
